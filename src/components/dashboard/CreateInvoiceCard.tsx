...
export const CreateInvoiceCard: React.FC = () => {
  return (
    <div className="flex flex-col max-w-md mx-auto w-full md:max-w-2xl lg:max-w-4xl">
      <Card className="p-6 text-center bg-[#F2F2F2] border-purple-100">
        <div className="flex flex-col items-center space-y-4">

          {/* Figma SVG plus button */}
          <div className="w-[52px] h-[52px] cursor-pointer hover:scale-105 transition-transform">
            <svg
              width="52"
              height="52"
              viewBox="0 0 51 52"
          ...
          <div className="space-y-2">
            <h2 className="text-lg font-semibold text-purple-700">Create New Invoice</h2>
      ...
      <p className="text-md mt-4 text-center text-[#8134AF]">
